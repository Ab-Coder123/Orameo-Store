...
<section  className="text-gray-400body-font">
  <div  className="container px-5 py-24 mx-auto flex flex-wrap">
    <h2  className="sm:text-3xl text-2xl text-white font-medium title-font mb-2 md:w-2/5">Kickstarter Actually Pinterest Brunch Bitters Occupy</h2>
    <div  className="md:w-3/5 md:pl-6">
      ...
      <div  className="flex md:mt-4 mt-6">
        ...
        <a  className="text-indigo-400 w-72 inline-flex items-center ml-4">Learn More
          <svg fill ="none" stroke="currentColor" className="w-5" viewBox="0 0 24 24">
 ...
 <footer className="text-gray-400 bg-gray-900 body-font">
  ...
  <div className="bg-gray-800 bg-opacity-75">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-400 text-sm text-center sm:text-left">© 2020 DopamineCode7 —
         <Link to="linkedin.com/in/abdo-ahmed-ali-708a5a213" className="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">@Abdulrahman</Link>
      </p>
