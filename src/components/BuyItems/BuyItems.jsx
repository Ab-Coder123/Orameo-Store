...
const BuyItems = (props) => {
  const { product } = props;
  const elemnt = document.getElementById("#acsess") ;
      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto  flex flex-wrap">
            <img
              alt="ecommerce"
              className="lg:w-1/2 object-center  rounded-lg  object-contain w-full h-full block rounded"
              src={product.image}
            />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h1 className="text-4xl title-font text-black font-bold tracking-widest">
              {product.title}
              </h1>
              <h3 className="text-gray-600 text-lg title-font font-medium mb-1">
              {product.Des}
              ...
              <div className="flex">
                ...
                <Link to="">
                  <button onClick={onclick} id="click" className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-2 focus:outline-none hover:bg-indigo-600 rounded">
                    Buy Now
                  </button>
                </Link>
...
{/* acsess */}
        <div id="acsess" className=" flex flex-col justify-around  p-4 border border-white border-opacity-30 rounded-lg shadow-md max-w-3xl h-72 mx-auto ">
