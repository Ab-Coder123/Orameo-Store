...
<header className="text-gray-600 body-font">
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
      ...
      <Link to="/modules/Products/Productspage" className="mr-5 hover:text-gray-900">Product</Link>
      <Link to="" className="mr-5 hover:text-gray-900">Members</Link>
      <Link to="/modules/Contact/Contact" className="mr-5 hover:text-gray-900">Contact</Link>
    </nav>
    
    <div className=" flex flex-wrap items-center">
    <Link to='/modules/Cart/Cart'>
    <button className="inline-flex items-center mr-5  bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Cart
